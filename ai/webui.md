...
- Use the shared `warning` color token and warning component variants for temporary operator interventions such as matcher bypasses; these states require attention but are not runtime errors.
