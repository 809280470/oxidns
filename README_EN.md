...
| System integrations | `ipset`, `nftset`, `ros_address_list` (recommended RouterOS address-set integration), `ros_route` (advanced per-IP routing; both support TLS), `reverse_lookup` |
