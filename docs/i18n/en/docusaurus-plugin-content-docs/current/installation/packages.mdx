...
A manual archive does not create a system service. For long-running deployments, use the built-in `oxidns service install`; see [Command-Line Tools](../cli.md#service) for all options.
