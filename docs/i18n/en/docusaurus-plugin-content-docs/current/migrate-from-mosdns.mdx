...
Syncs resolved IPs to a MikroTik RouterOS address-list in real time, enabling DNS-driven traffic routing alongside routing policy rules. See [`ros_address_list`](plugin-reference/executor.mdx#ros_address_list).
